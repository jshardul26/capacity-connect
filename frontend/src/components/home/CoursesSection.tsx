...
export const CoursesSection: React.FC = () => {
  ...
  // Sample/Preview course catalog demonstrating Phase 5 curriculum packaging
  // Future Dynamic Integration: GET /api/v1/courses (Phase 5 Learning Management API)
  const courses: CourseCardData[] = [
    {
      ...
      instructorTitle: 'Radar Meteorologist (Demo Profile)',
      rating: 4.9,
      enrolledCount: 142,
    ...
    },
    {
      ...
      instructorTitle: 'NWP Specialist (Demo Profile)',
      rating: 4.8,
      enrolledCount: 98,
    ...
    },
    {
      ...
      instructorTitle: 'Satellite Forecaster (Demo Profile)',
      rating: 4.9,
      enrolledCount: 215,
    ...
    },
    {
      ...
      instructorTitle: 'Instruments Specialist (Demo Profile)',
      rating: 4.7,
      enrolledCount: 180,
    ...
    },
    {
      ...
      durationHours: 14.0,
      lessonCount: 20,
      instructorName: 'Cyclone Specialist Desk',
      instructorTitle: 'Disaster Warning Division (Demo Profile)',
      rating: 5.0,
      enrolledCount: 310,
    ...
    },
    {
      ...
      instructorTitle: 'Agromet Division (Demo Profile)',
      rating: 4.8,
      enrolledCount: 165,
          ...
          <div className="bg-white rounded-2xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 space-y-4 animate-in fade-in zoom-in duration-200">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded bg-amber-100 text-amber-800 text-[10px] font-mono font-semibold">
                  SYLLABUS PREVIEW
                </span>
              </div>
              <button
            ...
            <div className="space-y-2">
              ...
              <p className="text-[11px] text-slate-400 font-mono italic">
                * Sample curriculum packaging preview for Phase 5 LMS integration.
              </p>
            </div>
